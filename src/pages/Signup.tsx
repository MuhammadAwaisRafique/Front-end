        ...
        <div className="bg-white rounded-xl shadow-sm border border-border/40 p-8">
          ...
          <Tabs defaultValue="student" className="mb-8">
            <TabsList className="grid grid-cols-2 w-full">
              ...
              <TabsTrigger value="tutor" onClick={() => setUserType("tutor")}>
                <Users className="mr-2 h-4 w-4" /> Tutor
              </TabsTrigger>
            </TabsList>
            <TabsContent value="student">
              <p className="text-sm text-muted-foreground mt-2">
                Create an account to access courses, engage with tutors, and track your progress.
              </p>
            </TabsContent>
            <TabsContent value="tutor">
              <p className="text-sm text-muted-foreground mt-2">
                Join as a tutor to create courses, share your knowledge, and connect with students worldwide.
              </p>
            </TabsContent>
          </Tabs>
